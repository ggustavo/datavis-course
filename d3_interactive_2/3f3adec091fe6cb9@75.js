...
md`${container()}`
  ...
  main.variable(observer("buildvis")).define("buildvis", ["magnitudeChart","magDimension","magDimensionCount","d3","depthChart","depthDimension","depthDimensionCount","timeChart","hourDimension","hourDimensionCount","dataset","dataTable","dateDimension","dc","updateMarkers","map","updateFilters"], function(magnitudeChart,magDimension,magDimensionCount,d3,depthChart,depthDimension,depthDimensionCount,timeChart,hourDimension,hourDimensionCount,dataset,dataTable,dateDimension,dc,updateMarkers,map,updateFilters)
{
