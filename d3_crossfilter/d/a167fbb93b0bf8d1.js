...
d3.csv("https://gist.githubusercontent.com/emanueles/d8df8d875edda71aa2e2365fae2ce225/raw/1e949d3da02ed6caa21fe3a7a12a4e5a611a4bab/stocks.csv").then(function(data){
  ...
  data.forEach(function(d,i){
       ...
       if(lastG == null && lastF == null){
          ...
          d.google =   (( (+d.google) - lastG ) / lastG) * 100
          d.facebook = (( (+d.facebook) - lastF) / lastF) * 100
...
require("d3")
  ...
  main.variable(observer("dataMovies")).define("dataMovies", ["d3"], function(d3){return(
d3.json("https://raw.githubusercontent.com/emanueles/datavis-course/master/assets/files/observable/movies.json").then(function(data){
  ...
  main.variable(observer("moviesFacts")).define("moviesFacts", ["crossfilter","dataMovies"], function(crossfilter,dataMovies){return(
crossfilter(dataMovies)
)});
  main.variable(observer("by_year")).define("by_year", ["moviesFacts"], function(moviesFacts){return(
moviesFacts.dimension( d => d.Year)
)});
  main.variable(observer("by_year_group")).define("by_year_group", ["by_year"], function(by_year){return(
by_year.group().reduceSum(d => d.Worldwide_Gross_M)
)});
  main.variable(observer("by_year_chart")).define("by_year_chart", ["md","container","dc","d3","by_year","by_year_group"], function(md,container,dc,d3,by_year,by_year_group)
{
  ...
  main.variable(observer("by_genre")).define("by_genre", ["moviesFacts"], function(moviesFacts){return(
moviesFacts.dimension( d => d.Genre)
)});
  main.variable(observer("by_genre_group")).define("by_genre_group", ["by_genre"], function(by_genre){return(
by_genre.group().reduceSum(d => +d.Worldwide_Gross_M)
)});
  main.variable(observer("by_genre_chart")).define("by_genre_chart", ["md","container","dc","d3","by_genre","by_genre_group"], function(md,container,dc,d3,by_genre,by_genre_group)
{
  let view = md`${container('chart4','Total arrecadado nas bilheterias por gênero de 2007 a 2011(em milhões de dólares)')}`
